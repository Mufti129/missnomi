...
analysis = st.sidebar.radio("Pilih Analisis:", "Overview","Forecasting", "Descriptive", "Correlation","Sales by Channel","Monitoring Produk","Pareto Produk","Gross Profit & Margin","Klasifikasi Produk","Monitoring & Analisis Retur"])
